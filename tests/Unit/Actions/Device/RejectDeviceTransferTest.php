...
class RejectDeviceTransferTest extends TestCase
{
    ...
    public function test_should_return_true_when_a_pending_transfer_is_successfully_rejected(): void
    {
        $this->assertTrue(
            $this->targetUser->rejectDeviceTransfer($this->deviceTransfer)
        );
    }

    public function test_must_update_the_transfer_status_to_rejected_and_not_change_the_device_owner(): void
    {
        $this->targetUser->rejectDeviceTransfer($this->deviceTransfer);

        $this->assertEquals(
            $this->deviceTransfer->status,
            DeviceTransferStatus::REJECTED
        );
    ...
    public function test_should_return_an_exception_when_the_user_tries_to_reject_a_finalized_transfer_that_has_an_accepted_status(): void
    {
    ...
    public function test_should_return_an_exception_when_the_user_tries_to_reject_a_finalized_transfer_that_has_an_canceled_status(): void
    {
        $occuredException = false;
    ...
    public function test_should_return_an_exception_when_the_user_tries_to_reject_a_finalized_transfer_that_has_an_rejected_status(): void
    {
        $occuredException = false;
