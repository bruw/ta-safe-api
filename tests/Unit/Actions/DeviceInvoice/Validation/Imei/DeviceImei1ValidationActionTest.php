...
class DeviceImei1ValidationActionTest extends DeviceImeiValidationActionTestSetUp
{
    public function test_should_return_an_instance_of_device_validation_log(): void
    {
        $log = (new DeviceImei1ValidationAction($this->device, $this->invoiceProduct()))->execute();
    ...
    {
        (new DeviceImei1ValidationAction($this->device, $this->invoiceProduct()))->execute();
        ...
        $this->assertDatabaseHas('device_attribute_validation_logs', [
            ...
            'attribute_value' => $this->device->imei_1,
    ...
    {
        $log = (new DeviceImei1ValidationAction($this->device, ''))->execute();
